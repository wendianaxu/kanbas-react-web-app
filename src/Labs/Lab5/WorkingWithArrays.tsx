    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <a href={`${API}/${todo.id}/title/${todo.title}`} className="btn btn-primary float-end">
                Update Todo Title</a>
            <input defaultValue={todo.id} className="form-control w-25 float-start me-2" // id for which todo to update
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <input defaultValue={todo.title} className="form-control w-50 float-start" // edit title
            ...
            <input defaultValue={todo.id} className="form-control w-25 float-start me-2" // id for which todo to update
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <input checked={todo.completed} className="float-start" type="checkbox" // edit completed status
            ...
            <input defaultValue={todo.id} className="form-control w-25 float-start me-2" // id for which todo to update
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <input defaultValue={todo.description} className="form-control w-50 float-start" // edit description
