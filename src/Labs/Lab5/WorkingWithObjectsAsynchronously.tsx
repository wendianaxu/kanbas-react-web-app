...
export default function WorkingWithObjectsAsynchronously() {
  ...
  const updateTitle = async (title: string) => { // update title of assignment in the server
  ...
  return (
    <div id="wd-asynchronous-objects">
      ...
      <button className="btn btn-primary me-2" onClick={() => updateTitle(assignment.title)} > {/* button to update title */}
        Update Title
      </button>
